...
object MessageSender {
  ...
  def providerProperties(brokers: String,
                         keySerializer: String,
                         valueSerializer: String): Properties = {
...
class MessageSender[K, V](val brokers: String,
                          val keySerializer: String,
                          val valueSerializer: String) {

  import MessageSender._
  val producer =
    new KafkaProducer[K, V](providerProperties(brokers, keySerializer, valueSerializer))
